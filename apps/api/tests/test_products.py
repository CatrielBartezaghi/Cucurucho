...
def test_product_image_can_be_replaced_and_removed(
    ...
    first = client.put(
        ...
        files={"image": ("torta.png", b"first", "image/png")},
    )
    ...
    second = client.put(
        f"/api/productos/{product['id']}/imagen",
        files={"image": ("torta.webp", b"second", "image/webp")},
    )
...
def test_invalid_or_failed_image_keeps_the_current_image(
    ...
    uploaded = client.put(
        f"/api/productos/{product['id']}/imagen",
        files={"image": ("cono.jpg", b"valid", "image/jpeg")},
    ).json()
    ...
    failed = client.put(
        f"/api/productos/{product['id']}/imagen",
        files={"image": ("cono.png", b"new", "image/png")},
    )
